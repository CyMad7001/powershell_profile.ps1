...
if ($profile -notmatch 'VSCode' -and $host.Name -ne 'Visual Studio Code Host') {
    Write-Host -Object (@"
PSCommandPath:   - $($PSCommandPath)
 PSScriptRoot:    - $($PSScriptRoot)
 Profile:        $(Write-Host -Object ("2") -ForegroundColor Yellow -NoNewline) - $($profile.CurrentUserAllHosts)
...
#. 'C:\Data\___Personal___\__CloudDrives__\OneDrive\Private\Projects\FRFL\Microsoft\PowershellProfiles\__COMMON_USER_PROFILE__.ps1'
